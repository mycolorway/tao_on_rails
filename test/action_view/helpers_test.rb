...
class TaoOnRails::ActionView::HelpersTest < ActiveSupport::TestCase
  ...
  test 'tao_page helper' do
    html = tao_page 'test-page', class: 'test-page', layout: 'default', json: {x: 1}.to_json.html_safe do
      '<header>Page Title</header>'.html_safe
    end
    assert_equal html, '<test-page class="test-page tao-page" layout="default" json="{&quot;x&quot;:1}"><header>Page Title</header></test-page>'
  end
